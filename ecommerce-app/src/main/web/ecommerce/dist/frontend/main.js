...
/* harmony import */ var ngx_paypal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-paypal */ "./node_modules/ngx-paypal/fesm5/ngx-paypal.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OrdersComponent = /** @class */ (function () {
    ...
    OrdersComponent.prototype.loadTotal = function () {
        ...
        this.sub = this.ecommerceService.TotalChanged.subscribe(function () {
            ...
            _this.totalStr = _this.total + '';
        });
    };
    OrdersComponent.prototype.initConfig = function () {
        var _this = this;
        this.payPalConfig = {
            currency: 'USD',
            clientId: 'sb',
            ...
            onClientAuthorization: function (data) {
                _this.successMessage = "Your order is placed successfully.";
                console.log('onClientAuthorization - you should probably inform your server about completed transaction at this point', data);
                _this.ecommerceService.saveOrder(_this.orders).subscribe();
            },
...
var EcommerceService = /** @class */ (function () {
    function EcommerceService(http) {
        this.http = http;
        this.productsUrl = "/product/api/v1/products";
        this.ordersUrl = "/order/api/v1/orders";
...
module.exports = __webpack_require__(/*! /Users/sagardahiya/Documents/SagarDev/untitled/ecommerce-parent/ecommerce-app/src/main/web/ecommerce/src/main.ts */"./src/main.ts");
